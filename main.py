...
from constants import (
    ...
    OCEAN_BLUE, WHITE, BLACK, RED, BLUE, GREEN, YELLOW, # colors
    TIME_PER_TURN,
    ARROWS
)
...
if not quit:
    while start_game:
        ...
        while round_start:  # battle starts
            ...
            nuke_status_blue = pygame.rect.Rect(1100, 700, 200, 10)  #
            if red_nuke:
            ...
            # Nuke buttons
            if round >= 1.5:
                nuke_button_blue = Button(1100, 600, 200, 100, "Nuke", WHITE, BLACK, BLUE, GREEN, activate_nuke) 
